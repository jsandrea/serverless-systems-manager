...
jest.mock('./package/maintenanceWindows/packageMaintenanceWindow', () => ({
  packageMaintenanceWindow: jest.fn().mockResolvedValue('mockedValue'),
}));
...
describe('ServerlessSystemsManager', () => {
  ...
  test('should call packageParameters on compileEvents hook', async () => {
    ...
    expect(packageMaintenanceWindow.packageMaintenanceWindow).toHaveBeenCalled();
